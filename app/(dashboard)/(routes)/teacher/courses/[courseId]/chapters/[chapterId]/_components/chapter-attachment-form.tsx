...
export const ChapterAttachmentForm = ({ initialData, courseId, chapterId }: ChapterAttachmentFormProps) => {
      ...
      {!isEditing ? (
        ...
        <div>
          ...
          <div className="text-xs text-muted-foreground mt-4">
            Ajoutez des documents et fichiers dont les apprenants auront besoins pour ce chapitre
          </div>
        </div>
      )}
    </div>
